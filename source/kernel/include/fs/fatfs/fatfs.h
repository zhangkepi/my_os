...
#define     DIR_ITEM_ATTR_READ_ONLY     0x1
#define     DIR_ITEM_ATTR_HIDDEN        0x2
#define     DIR_ITEM_ATTR_SYSTEM        0x4
#define     DIR_ITEM_ATTR_VOLUME_ID     0x8
#define     DIR_ITEM_ATTR_DIRECTORY     0x10
#define     DIR_ITEM_ATTR_ARCHIVE       0x20
#define     DIR_ITEM_ATTR_LONG_NAME     0xF

#define     DIR_ITEM_FREE_FLAG          0xE5
#define     DIR_ITEM_END_FLAG           0x00
